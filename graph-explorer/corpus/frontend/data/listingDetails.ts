...
const generateListingDetails = (
  ...
  return {
    ...
    garage: 1,
    mainImage: image,
    thumbnails: ["/images/2.jpg", "/images/3.jpg", null, null] as (
      | string
      | null
    )[],
...
This is an excellent opportunity to own a piece of Ottawa's vibrant downtown core. The property is move-in ready and available for immediate possession.`,
    ...
    incomeDistribution: [
      ...
      { range: "$20K-$39K", value: 0.1, color: "#06b6d4" },
      { range: "$40K-$59K", value: 0.15, color: "#3b82f6" },
      { range: "$60K-$79K", value: 0.2, color: "#8b5cf6" },
...
export const LISTING_DETAILS: Record<string, ListingDetailsData> = {
  "new-listings": generateListingDetails(
    "new-listings",
    "New Listings",
    "/images/1.jpg",
  ),
  "price-reduced": generateListingDetails(
    "price-reduced",
    "Price Reduced",
    "/images/2.jpg",
  ),
  "open-houses": generateListingDetails(
    "open-houses",
    "Open Houses",
    "/images/3.jpg",
  ),
  "recently-sold": generateListingDetails(
    "recently-sold",
    "Recently Sold",
    "/images/4.jpg",
  ),
  "new-construction": generateListingDetails(
    "new-construction",
    "New Construction",
    "/images/5.jpg",
  ),
  land: generateListingDetails("land", "Land", "/images/6.jpg"),
  foreclosures: generateListingDetails(
    "foreclosures",
    "Foreclosures",
    "/images/7.jpg",
  ),
