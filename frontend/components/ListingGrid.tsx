...
export const ListingGrid: React.FC<{ className?: string }> = ({ className = '' }) => {
  const listings = useListings();

  return (
    <div className={`max-w-7xl mx-auto px-6 py-8 ${className}`}>
      <h2 className="text-2xl text-center md:text-3xl font-bold mb-6">Browse homes in Miami Beach, FL</h2>
