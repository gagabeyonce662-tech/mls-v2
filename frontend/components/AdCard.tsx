...
const AdCard: React.FC<AdCardProps> = ({ title, description, buttonText, image, color }) => {
  return (
    <div className={`${color} rounded-xl p-6 text-white shadow-lg hover:shadow-xl transition-shadow duration-300`}>
      {image && (
