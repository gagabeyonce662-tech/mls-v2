...
export const SearchThisAreaButton = ({
  ...
  return (
    <div
      className="absolute top-20 lg:top-8 left-0 right-0 lg:right-[380px] xl:left-[380px] z-[39] lg:z-[999] flex justify-center pointer-events-none"
    >
      <Button
        onClick={onClick}
        disabled={loading}
      ...
      >
        <span className="font-bold text-xs lg:text-sm">Properties in this area</span>
        {loading ? (
