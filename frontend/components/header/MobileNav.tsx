            ...
            <div className="flex items-center justify-between px-4 h-16">
                ...
                <div className="flex items-center space-x-4">
                    <Sheet open={isOpen} onOpenChange={setIsOpen}>
                        ...
                        <SheetContent side="left" className="w-[300px] bg-[#0C1536] p-0 border-r border-white/10">
                            <div className="flex flex-col h-full">
                                ...
                                <div className="flex-1 overflow-y-auto p-6 space-y-8">
                                    ...
                                    <div>
                                        <h3 className="text-xs font-semibold text-[#4C7DFF] uppercase tracking-widest mb-4">Location</h3>
                                        <ProvinceSelector variant="mobile" />
                                    </div>

                                    {/* Navigation Links */}
                                    <div>
                                        <h3 className="text-xs font-semibold text-[#4C7DFF] uppercase tracking-widest mb-4">Navigation</h3>
                                ...
                                <div className="p-6 border-t border-white/5 space-y-4">
                                    <Link href="/login" className="w-full" onClick={() => setIsOpen(false)}>
                                        <Button className="w-full text-white border-white/10 hover:bg-white/5" variant="outline">
                                            Login
                                        </Button>
                                    </Link>
                                    <Link href="/valuation" className="w-full" onClick={() => setIsOpen(false)}>
                                        <Button
