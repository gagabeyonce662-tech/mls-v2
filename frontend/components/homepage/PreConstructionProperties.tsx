...
import { useAllPreConnProperties, usePrefetchProperty } from "@/lib/react-query";
...
export default function PreConstructionProperties({
  ...
  const { 
    ...
    isError,
    isFetching
  } = useAllPreConnProperties({
    // Optimize for initial load
    placeholderData: [],
    staleTime: 10 * 60 * 1000, // 10 minutes cache for pre-construction
  });
        ...
        {isError && (
          <div className="text-center py-16">
            <div className="text-xl font-semibold mb-2" style={{ color: colors.heading }}>
              Error loading pre-construction properties
            </div>
            <p style={{ color: colors.body }}>
