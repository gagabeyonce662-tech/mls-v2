...
export default function LocationsSection() {
  ...
  return (
    <div className="py-8 bg-white overflow-hidden"> {/* was py-20 */}
      <div className="max-w-[1800px] mx-auto px-4 mb-4"> {/* was mb-10 */}
        <h2 className="text-ds-h2 text-ds-heading font-inter text-[22px] mb-2"> {/* tighter */}
          Our locations for you
        </h2>
      </div>

      <div className="relative overflow-hidden">
        <div className="flex gap-4 w-max marquee-track"> {/* was gap-8 */}
          {marqueeLocations.map((location, i) => (
            ...
            >
              ...
              <div className="absolute inset-0 flex items-end justify-center p-4">
                <h3 className="text-white text-lg font-semibold tracking-wide"> {/* more compact */}
                  {location.name}
                </h3>
              </div>
            </div>
