          ...
          {reviews.map((review) => (
            <div key={review.id} className="bg-white rounded-xl shadow-md p-6 space-y-4">
              <div className="flex items-center gap-4">
                ...
                />
                <div>
                  <h3 className="text-ds-text text-ds-heading font-inter">{review.name}</h3>
                  <p className="text-ds-small-regular text-ds-body font-inter">{review.location}</p>
                </div>
              </div>
              ...
              <p className="text-ds-body-regular text-ds-body leading-relaxed font-inter">{review.text}</p>
            </div>
          ))}
        </div>
      </div>
