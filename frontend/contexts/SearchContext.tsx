...
export function SearchProvider({ children }: { children: ReactNode }) {
    ...
    const updateSearchResults = useCallback((results: Property[], query: string) => {
    ...
    const applyFilters = useCallback((properties: Property[], label: string = "Filtered Properties") => {
