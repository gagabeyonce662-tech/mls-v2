 ...
 */
export const getTextStyle = (style: keyof typeof designSystem.textStyles): string => {
 ...
 */
export const getColorStyle = (color: keyof typeof designSystem.colorStyles): string => {
...
export const ds = {
  ...
  // Buttons
  btnPrimary: 'bg-ds-primary hover:bg-blue-900 text-white px-6 py-3 rounded-md font-semibold transition-colors',
  btnSecondary: 'bg-ds-card hover:bg-gray-300 text-ds-heading px-6 py-3 rounded-md font-semibold transition-colors',
  btnOutline: 'border-2 border-ds-primary text-ds-primary hover:bg-ds-primary hover:text-white px-6 py-3 rounded-md font-semibold transition-colors',
  
  // Cards
  card: 'bg-ds-card border border-ds-card-border rounded-xl shadow-md',
  cardHover: 'bg-ds-card border border-ds-card-border rounded-xl shadow-md hover:shadow-xl transition-shadow',
  
  // Input
  input: 'w-full px-4 py-3 border border-ds-card-border rounded-md focus:outline-none focus:ring-2 focus:ring-ds-primary',
} as const;
